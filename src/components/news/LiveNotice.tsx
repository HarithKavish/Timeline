...
export function LiveNotice({ outlets }: { outlets: NewsOutlet[] }) {
  ...
  return (
    <aside className="live-notice" aria-label="Data status">
      ...
      <p>
        Ingested every 5 minutes across five tiers — International (excluding India), National
        (India), State (Tamil Nadu), District (Virudhunagar) and City (Rajapalayam) — from{' '}
