...
const SYSTEM_PROMPT = [
  ...
  '',
  'Always write your log entry in English, even when the source article is in',
  'another language (Tamil sources are common here) — translate the fact, don\'t',
  'just describe it in the source language.',
  '',
